...
static void print_stats(int stats_fd, __u64 rates[], __u64 ceils[])
{
    ...
    printf("\033[2J\033[H");
    printf("╔════════════════════════════════════════════════════════════════════════════════════╗\n");
    printf("║        eBPF QoS — Phase 3: EDT Shaping + Bandwidth Borrowing                      ║\n");
    printf("╠════════════════════════════════════════════════════════════════════════════════════╣\n");
    printf("║  Class         │ Rate/Ceil   │  Packets     │  Borrowed    │  Delayed     │ Mbit/s ║\n");
    printf("╠════════════════╪═════════════╪══════════════╪══════════════╪══════════════╪════════╣\n");

    __u64 tp = 0, tb = 0, td = 0;
    for (int i = 0; i < TC_MAX; i++) {
        ...
        printf("║  %s │ %3llu/%3llu M   │  %10llu  │  %10llu  │  %10llu  │ %6.1f ║\n",
            class_names[i], rates[i], ceils[i],
            s[i].packets, s[i].borrowed, s[i].delayed, mbps);
    }
    ...
    printf("║  TOTAL          │             │  %10llu  │  %10llu  │  %10llu  │        ║\n",
        tp, tb, td);
    printf("╚════════════════════════════════════════════════════════════════════════════════════╝\n");
    printf("\n  Mode: SHAPING (delay, not drop) + Borrowing (ceil > rate)\n");
    printf("  Packets→Borrowed = sent using borrowed BW | Delayed = held by FQ qdisc\n");
